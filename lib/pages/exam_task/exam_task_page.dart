...
class _ExamTaskPageState extends State<ExamTaskPage> {
  ...
  Widget _buildStatusChip(String label) {
    ...
    return FilterChip(
      ...
      shape: RoundedRectangleBorder(
        ...
        side: BorderSide(
          color: isSelected ? Colors.indigo : colorScheme.borderColor,
        ),
      ),
    );
  }
  ...
  Widget _buildTaskCard(ElearnTask task, bool isWideLayout) {
    ...
    bool isSelected =
        isWideLayout && _selectedTask != null && _selectedTask!.id == task.id;
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        if (task.score != null) ...[
                          Text(
                            task.score!.toString().replaceAll(
                              RegExp(r'\.0$'),
                              '',
                            ),
                            style: TextStyle(
