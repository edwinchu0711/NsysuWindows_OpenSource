...
class CourseStatusTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (otherList.isNotEmpty) {
      ...
      listChildren.addAll(
        otherList.map((c) => _buildCourseCard(c, isDimmed: true)),
      );
    }
                        ...
                        RichText(
                          text: TextSpan(
                            ...
                            children: [
                              ...
                              TextSpan(
                                text:
                                    "${registeringCredits.toStringAsFixed(0)}",
                                style: const TextStyle(
        ...
        builder: (context) {
          ...
          return Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: isDimmed ? Colors.transparent : colorScheme.borderColor,
              ),
            ),
            child: Padding(
                        ...
                        Row(
                          children: [
                            Icon(
                              ...
                              size: 14,
                              color: colorScheme.subtitleText.withOpacity(0.6),
                            ),
...
class CoursePreviewPage extends StatelessWidget {
  ...
  List<String> _calculateVisiblePeriods(
    ...
    if (_checkPeriodHasCourse(map, 'F')) {
      result.addAll(['D', 'E', 'F']);
    } else if (_checkPeriodHasCourse(map, 'E')) {
      result.addAll(['D', 'E']);
    } else if (_checkPeriodHasCourse(map, 'D')) {
      result.addAll(['D']);
    }
    return result;
  }
